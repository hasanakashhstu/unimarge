    ...
    <div class="main-blog-area pd-top-100 pd-bottom-90 bg-white">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <p>{{ $event->getDepartment->department_name }}</p>
                </div>
            </div>
            <hr>
            <div class="row">
                <div class="col-lg-12">
                    <a class="btn btn-primary mt-2" href="{{ Storage::url($event->image) }}"
                        download="{{ $event->title }}"><svg xmlns="http://www.w3.org/2000/svg" width="16"
