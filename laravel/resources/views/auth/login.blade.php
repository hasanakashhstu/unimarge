...
<body>
    ...
    <div class="control-group normal_text text-center"><img src="{{ URL::asset('img/logo.png') }}" alt="Logo"
            height="60px" width="80px" /><br><br>
    ...
    <div id="loginbox">
        {{ Form::open(['url' => route('login'), 'method' => 'post', 'id' => 'loginform', 'class' => 'form-vertical']) }}

        <div class="control-group">
            <div class="controls">
                <div class="main_input_box">
                    <span class="add-on bg_lg"><i class="icon-user">
                        </i></span>{{ Form::text('email', '', ['placeholder' => 'Email Address', 'title' => 'Email Address']) }}
                </div>
            </div>
        </div>
            ...
            <div class="controls">
                <div class="main_input_box">
                    <span class="add-on bg_ly"><i
                            class="icon-lock"></i></span>{{ Form::password('password', ['placeholder' => 'Password', 'title' => 'Password']) }}
                </div>
            </div>
        </div>


        {{-- user type (not nedded) --}}
        {{-- <div class="control-group">
            <div class="controls">
                <div class="main_input_box">
                    {{ Form::select('user_type', ['Software User' => 'Software User', 'Website User' => 'Website User', 'Student' => 'Student', 'Parent' => 'Parent'], null, ['style' => 'width: 89%']) }}
                </div>
            </div>
        </div> --}}
        ...
        <div class="controls">
            <div class="main_input_box">
                <span class="add-on bg_lo"><i
                        class="icon-envelope"></i></span>{{ Form::email('email', '', ['placeholder' => 'E mail Address', 'title' => 'email']) }}
            </div>
