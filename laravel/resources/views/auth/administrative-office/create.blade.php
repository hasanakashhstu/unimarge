...
@section('content')
    ...
    <div class="widget-content nopadding">
        <div class="container">
            <h2><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp;Create Office</h2> <!-- Tab Heading  -->
            <p title="Transport Details">{{ Session::get('school.system_name') }} Create Office</p>
            <!-- Transport Details -->
            ...
            <div class="widget-box">
                ...
                <div class="widget-content padding">
                    <form action="{{ route('auth.administrativeOffices.store') }}" method="post">
                        @csrf
