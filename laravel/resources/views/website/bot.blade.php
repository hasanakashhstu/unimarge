    ...
    <div class="page-title-area bg-overlay text-center">
        <div class="container">
            <div class="breadcrumb-inner">
                <h4 class="">About</h4>
                <h2 class="page-title">Board of Trustees</h2>
            </div>
        </div>
    </div>
    <!-- page title end -->
                    ...
                    <div class="col-lg-4 ">
                        <div class="details">
                            ...
                            <ul class="social-media style-base pt-4">
                                <li>
                                    <a href="{{ $bot_chairman->facebook }}"><i class="fa fa-facebook" aria-hidden="true"
                                            style="line-height: 32px;"></i></a>
                                </li>
                                <li>
                                    <a href="{{ $bot_chairman->twitter }}"><i class="fa fa-twitter" aria-hidden="true"
                                            style="line-height: 32px;"></i></a>
                                </li>
                                <li>
                                    <a href="{{ $bot_chairman->instagram }}"><i class="fa fa-instagram" aria-hidden="true"
                                            style="line-height: 32px;"></i></a>
                                </li>
                                <li>
                                    <a href="{{ $bot_chairman->pinterest }}"><i class="fa fa-pinterest" aria-hidden="true"
                                            style="line-height: 32px;"></i></a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="/frontend/message_bot_vc"><i class="fa fa-angle-right"
                                            aria-hidden="true"></i> Messege of BoT VC</a>
                                </li>
                                <li class="nav-item">
