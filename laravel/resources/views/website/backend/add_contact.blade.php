...
<div class="container">
    <h2><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp;Contact</h2> <!-- Tab Heading  -->
    <p title="Transport Details">@if (Session::has('school')) {{Session::get('school.system_name')}}  @endif Contact</p> <!-- Transport Details -->
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="widget-content padding">
                    {{Form::open(['url'=>'/frontend/contact','class'=>'form-horizontal','method'=>'post','files'=>true,'name'=>'basic_validate','id'=>'basic_validate','novalidate'=>'novalidate'])}}
                   ...
                   <tbody>
                    ...
                    <tr class="gradeX">
                       ...
                       <td id="my_align" class="display_status">
                        ...
                        {{Form::open(['url'=>"/frontend/contact/$value->id/edit" ,'method'=>'GET'])}}
                          {{Form::submit('Edit',['class'=>'btn btn-primary'])}} 
                        {{Form::close()}}
                     
                        {{Form::open(['url'=>"/frontend/contact/$value->id" ,'method'=>'DELETE'])}}
