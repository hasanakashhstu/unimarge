@extends('admin.index')
@section('Title', 'Add Event Information')
@section('breadcrumbs', 'Add Event')
@section('breadcrumbs_link', '/frontend/events')
@section('breadcrumbs_title', 'Add Event')
...
@section('content')
    ...
    <div class="widget-content nopadding">
        <div class="container">
            <h2><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp;Add Event</h2> <!-- Tab Heading  -->
        ...
        <div class="widget-box">
            <div class="widget-title">
                ...
                <h5>Add Event Information</h5>
            </div>

            <div class="widget-content padding">
                {{ Form::open(['url' => '/frontend/events','class' => 'form-horizontal','method' => 'POST','files' => true,'name' => 'basic_validate','id' => 'basic_validate','novalidate' => 'novalidate']) }}
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        {{ Form::date('start_date', old('start_date'), ['id' => 'required','placeholder' => 'Designation','title' => 'Designation']) }}
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        {{ Form::image(null, 'image', ['alt' => 'Image','class' => 'img-responsive img-circle blank_applicant_student_image','id' => 'blah','style' => 'width:19%']) }}
                        <br>
