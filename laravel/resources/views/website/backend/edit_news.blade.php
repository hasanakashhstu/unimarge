    ...
    <div class="widget-content nopadding">
        ...
        <div class="widget-box">
            ...
            <div class="widget-content padding">
                {{ Form::open(['url' => "/frontend/news/$news->website_news_id",'class' => 'form-horizontal','method' => 'PUT','files' => true,'name' => 'basic_validate','id' => 'basic_validate','novalidate' => 'novalidate']) }}

                <div class="control-group">
                    {{ Form::label('title', 'Title', ['class' => 'control-label', 'title' => 'title']) }}
                    <div class="controls">
                        {{ Form::text('title', old('title', $news->title), ['id' => 'required','placeholder' => 'Title','title' => 'title']) }}
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            {{ Form::textarea('description', old('description', $news->description), ['id' => 'description','placeholder' => 'Designation','title' => 'Designation']) }}
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            {{ Form::date('news_date', old('title', $news->news_date), ['id' => 'required','placeholder' => 'News Date','title' => 'news_date']) }}
                        </div>
                    </div>
                            ...
                            <select name="department">
                                ...
                                @foreach ($departments as $departments_list)
                                    <option value="{{ $departments_list->id }}"
                                        @if (old('department', $news->department) == $departments_list->id) selected @endif>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <a href="{{ Storage::url($news->file) }}" class="btn btn-primary" target="_blank">News
                                File</a>
                        </div>
                    </div>
