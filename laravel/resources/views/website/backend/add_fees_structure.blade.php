@extends('admin.index')
@section('Title', 'Add Fess Structure')
...
@section('content')
    ...
    <div class="container">
        <h2><i class="fa fa-plus-circle" aria-hidden="true"></i>Add Fees Structure</h2> <!-- Tab Heading  -->
        <p title="Transport Details">{{ Session::get('school.system_name') }} Add Fees Structure</p><br />
        <!-- Transport Details -->
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            {{ Form::textarea('fees_structure', old('fees_structure'), ['id' => 'fees_structure','placeholder' => 'Fees Structure','title' => 'Fees Structure']) }}
                        </div>
                    </div>
