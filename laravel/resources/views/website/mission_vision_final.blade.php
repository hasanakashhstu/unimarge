    ...
    <div class="page-title-area bg-overlay text-center">
        <div class="container">
            <div class="breadcrumb-inner">
                <h4 class="">About</h4>
                <h2 class="page-title">Vission, Mission & Strategy</h2>
            </div>
        </div>
    </div>
    <!-- page title end -->
        ...
        <div class="container">
            <div class="team-details-page">
                ...
                <div class="details align-self-center text-justify pd-top-30">
                    <h2 class="mb-2">Our Vission</h2>
                    <hr>
                    <div class="row">
                        <div class="col-lg-12"> 
                        {!! $website_setup->vision !!}  
                        </div>
                    </div>
                </div>
                <div class="details align-self-center text-justify pd-top-30">
                ...
                <div class="details align-self-center text-justify pd-top-30">
                    <h2 class="mb-2">Strategy</h2>
                    <hr>
                    <div class="row">
                        <div class="col-lg-12">
                             {!! $website_setup->strategy !!}
