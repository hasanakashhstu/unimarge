    ...
    <div class="page-title-area bg-overlay text-center">
        <div class="container">
            <div class="breadcrumb-inner">
                <!-- Online Admission -->
                <h2 class="page-title">Online Admission</h2>
            </div>
        </div>
    </div>
    <!-- page title end -->
                        ...
                        <div style="padding: 10px;" class="row">
                            <div class="widget-box online_admission">
                                <div class="widget-content nopadding">
                                    ...
                                    <p>&nbsp;</p>
                                    <div class="applicant_student_block_heading">The Following Documents are to be attached
                                    </div>
                                    <div class="applicant_student_block reference">
                                        <div class="col-md-12">
                                            <ul>
                                                <li>Money Receipt of Application Registration Form</li>
                                                <li>Testimonials from the Heads of Institutions from where the candidate has
                                                ...
                                                <li>Attested copies of mark sheets/Candidates of S.S.C & H.S.C/Equivalent
                                                    Examination.</li>
                                    ...
                                    <div class="applicant_student_block reference">
                                        <div class="col-md-12">
                                            <ul>
                                                <li>I, hereby solemnly declare and legally bind myself to confirm to the Rules
                                                    and Regulations of the University at present in force or
                                                    may hereafter be made and i undertake the so long as I am a Student of the
                                                    Universty i will do nothing either inside of outside the
                                                    University that will unterfere with the discipline and the other of
                                                    Ordinances of University Grant Commission relating Course, Syllabus and
                                                    Examination at present on force or that may hereafter be made to this
                                                    effect.</li>

                                                <li>I shall be liable to tbe expelled from the University if any of the above
                                                    information each found to be false or fabricated, all fees and
                                                    other dues paid by me to the University up to that time shall be forefeited.
                                                    I and my father/legal guardian would also be liable to any
                                                    further departmental or legal action that the authorities may deem
                                                    necessary.</li>
                                                <li>
                                                    I further solemnly declare that there is no personal, domestic or financial
                                                    circumnstances which may prevent me from continuing my studies in this
                                                    University until the completion of the entire course of studies.
                                                </li>

                                                <li>I further declare that i shall not do any activities subversive to the
                                                    discipline of the institution and/or of the State (Such as Strike, Hartal &
                                                    Boycott etc.)</li>

                                                <li>I hereby certify that the above statement of Particulars are tru and
                                                    correct.</li>
                                            </ul>
                                        </div>
                                    </div>
