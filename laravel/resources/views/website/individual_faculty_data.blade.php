    ...
    <div class="page-title-area bg-overlay text-center">
        <div class="container">
            <div class="breadcrumb-inner">
                <h4 class="">{{$teacher_info->department_name}} / Faculty Member</h4>
...
{{--                                    <img src="images/dean.jpg" alt="img">--}}
                                    <img onerror="this.src='img/blankavatar.png'" src='{{URL::asset("img/backend/teacher_staff/$teacher_info->teacher_id")}}.jpg' alt="img">
                                </div>
                            </div>
                            <div class="col-lg-8 align-self-center">
                                <div class="details">
                                    <h4 class="name">{{$teacher_info->teacher_name}}</h4>
                                    <p class="designation">{{$teacher_info->designation}}</p>
                                    <p class="department-name">{{$teacher_info->department_name}}</p>
                                    <div class="contact-area no-padding-margin">
                                        <ul class="details no-padding-margin">
                                            <li><i class="fa fa-map-marker"></i>Dhaka Bangladesh
                                                P.S.: {{$teacher_info->post_office}}, Dist.: {{$teacher_info->home_district}}
                                            </li>
                                            <li><i class="fa fa-envelope"></i>{{$teacher_info->email}}</li>
                                            <li><i class="fa fa-phone"></i> {{$teacher_info->mobile_no}}</li>
                                        </ul>
                                        <ul class="social-media style-base no-padding-margin">
                                            <li>
                                                <a href="{{$teacher_info->social_network_1}}" target="_blank"><i class="fa fa-facebook" aria-hidden="true" style="line-height: 31px;"></i></a>
                                            </li>
                                            <li>
                                                <a href="{{$teacher_info->social_network_2}}" target="_blank"><i class="fa fa-twitter" aria-hidden="true" style="line-height: 31px;"></i></a>
                                            </li>
                                            <li>
                                                <a href="{{$teacher_info->social_network_3}}" target="_blank"><i class="fa fa-instagram" aria-hidden="true" style="line-height: 31px;"></i></a>
                                            </li>
                                            <li>
                                                <a href="{{$teacher_info->social_network_4}}" target="_blank"><i class="fa fa-pinterest" aria-hidden="true" style="line-height: 31px;"></i></a>
                                            </li>
                                        </ul>
                                    </div>
...
{{--                                                            Singapore,</li>--}}
                                                        <li>{{$teacher_info->degree_name}}</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row ">
                                                        <div class="col-md-2">
                                                            <a href="" data-lightbox="gallaryImg">
                                                                <img src="{{asset('/assets/images/about-bg-1.jpg')}}"
