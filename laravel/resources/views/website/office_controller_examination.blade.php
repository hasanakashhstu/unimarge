        ...
        <div class="row mainwrapper">
            <div class="col-lg-12">
                <div class="row row_border" id="about">
                    <h3 class="header_msg_section_title">Office of the Controller of Examination</h3>
                    <hr>
                    <div class="about_content">
                        <img src="{{asset('website/index_files/sikderuniversity.jpg')}}" style="float: right; width: 50%; margin: 7px 10px 10px 10px;">
                        <p>{{$website_setup->about_us}}</p>
                    </div>
                </div>
               <!--  <div class="row">
