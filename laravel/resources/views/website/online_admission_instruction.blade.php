 ...
 @section('website_main_section')
     ...
     <div class="container">
        ...
        <div class="main_content">
            <div class="ins_title">Instruction & Guidline</div>
            <div class="application_top_content">
                ...
                <h6 class="ml-3">Guidelines for Submitting Online Admission Form</h6>
                <ul class="">
                    <li>
                        <i class="fa fa-check-square-o"></i> 
                        Use any (for best result Google Chrome or Mozila Firefox can be used) web browser to go to zhsust website (https://zhsust.edu.bd/) to get the zhsust Online Admission Form.   
                    </li>
                    <li>
                        <i class="fa fa-check-square-o"></i> 
                    ...
                    <li>
                        <i class="fa fa-check-square-o"></i> 
                        After selecting a Program, applicant will get option to fill in his/her Name, Mobile Number and email address (Optional). After filling the above fields a zhsust Login ID” will be displayed on the next screen. Applicant should note down the zhsust Login ID” (Example 12985632) as the applicant will require it for payment and further login. Applicant can also download/print the pay slip for payment. This "zhsust Login ID" is also sent to the applicants through email.
                    </li>
                    <li>
                        <i class="fa fa-check-square-o"></i> 
                        The Application Fee is Tk-1,400/-(Non Refundable) is to be paid in cash at zhsust Admission Office.
                    </li>
                    <li>
                        <i class="fa fa-check-square-o"></i> 
                ...
                <ul class="pb-3">
                  <li>
                        {{-- <i class="fa fa-check-square-o"></i> --}}
                        <span>For further help</span> applicants may contact zhsust Admission Office at A/2 Jahurul Islam Avenue, Jahurul Islam City, Aftabnagar, Dhaka or call: ,  Mobile:  or email:
                    </li>
                </ul>
