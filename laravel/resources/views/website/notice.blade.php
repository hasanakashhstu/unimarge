                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <table class="table table-hover">
                                        ...
                                        @foreach ($notice as $notice_data)
                                            <tr>
                                                ...
                                                <td>
                                                    <h2> <a
                                                            href="{{ url('frontend/notice/'. $notice_data->notice_id) }}">{{ str_limit($notice_data->notice_title, 150) }}</a>
                                                    </h2>
                                                    <p>{!! str_limit($notice_data->Notice, 150) !!}</p>
                                                </td>
                                                <td class="text-align-center">
                                                    <a class="btn btn-primary mt-2"
                                                        href="{{ Storage::url($notice_data->file) }}" download="{{ $notice_data->notice_title }}"><svg
                                    ...
                                    <div class="float-right">
                                        {{ $notice->links('vendor.pagination.bootstrap-4') }}
                                    </div>
                                </div>
                            </div>
                        </div>
