        ...
        <div class="container">
            <div class="team-details-page">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="thumb">
                            <img  src='{{ asset("img/backend/teacher_staff/$teacher->photo")}}' alt="img">
                    ...
                    <div class="col-lg-4 ">
                        <div class="details">
                            ...
                            <ul class="social-media style-base pt-4">
                                <li>
                                    <a href="{{$teacher->social_network_1}}"><i class="fa fa-facebook" aria-hidden="true" style="line-height: 34px;"></i></a>
                                </li>
                                <li>
                                    <a href="{{$teacher->social_network_2}}"><i class="fa fa-twitter" aria-hidden="true" style="line-height: 34px;"></i></a>
                                </li>
                                <li>
                                    <a href="{{$teacher->social_network_3}}"><i class="fa fa-instagram" aria-hidden="true" style="line-height: 34px;"></i></a>
                                </li>
                                <li>
                                    <a href="{{$teacher->social_network_4}}"><i class="fa fa-pinterest" aria-hidden="true" style="line-height: 34px;"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
