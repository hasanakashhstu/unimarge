...
<head>
        <title>University ERP</title><meta charset="UTF-8" />
...
<div class="control-group normal_text text-center">
    ...
    <h3 style="font-size:18px">অনলাইনে ক্লাস করাতে অবশ্যই গুগল ক্রম ব্রাউজার ব্যবহার করুন।</h3>
    </div><br>
            ...
            {{Form::open(['url'=>"/auth_check" , 'method'=>'post','id'=>'loginform','class'=>'form-vertical'])}}
                ...
                <div class="control-group">
                 ...
                 <div class="">
                    <div class="controls">
                        <div class="main_input_box">
                            <input type="hidden" name="user_type" value="Software User">
                        </div>
                    </div>
                </div>
