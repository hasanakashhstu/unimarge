...
@section('content')
    ...
    <div class="container">
        ...
        <p title="Transport Details">{{ Session::get('school.system_name') }} Staff Edit</p> <!-- Transport Details -->
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        {{ Form::text('teacher_name', $teacher->teacher_name, ['id' => 'required', 'title' => 'teacher_name', 'placeholder' => 'Staff Name']) }}
