...
@section('content')
    ...
    <div class="container">
        <h2><i class="fa fa-list-alt" aria-hidden="true"></i> &nbsp;Total Teacher Advance Report</h2> <!-- Tab Heading  -->
        <p title="Transport Details">{{ Session::get('school.system_name') }} Total Teacher Advance Report</p>
        <!-- Transport Details -->
        ...
        {{ Form::open(['url' => '/total_teacher_report', 'class' => 'form-horizontal', 'method' => 'post', 'name' => 'basic_validate', 'id' => 'basic_validate', 'novalidate' => 'novalidate']) }}
        ...
        margin-left: 10px" class="">
            ...
            <thead>
                <tr>
                    ...
                    <th style="background: #1F262D;height: 34px;     width: 181px;color: #fff;border: 1px solid white;">Job
                        Type</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        {{ Form::select('type', ['' => '--Select--', 'all' => 'all', 'Tech' => 'Tech', 'Non-Tech' => 'Non-Tech'], null, ['style' => 'width: 183px', 'id' => 'fees_class', 'class' => 'class']) }}
                    </td>
