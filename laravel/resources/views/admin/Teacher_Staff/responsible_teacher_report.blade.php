@extends('admin.index')
@section('Title', 'responsible_teacher_report')
@section('breadcrumbs', 'responsible_teacher_report')
@section('breadcrumbs_link', '/responsible_teacher_report')
@section('breadcrumbs_title', 'responsible_teacher_report')
@section('content')


    <div class="container">
        <h2><i class="fa fa-list-alt" aria-hidden="true"></i> &nbsp;Respnsible Teacher Advance Report</h2>
        <!-- Tab Heading  -->
        <p title="Transport Details">{{ Session::get('school.system_name') }} Respnsible Teacher Advance Report</p>
        <!-- Transport Details -->
        ...
        {{ Form::open(['url' => '/reponsible_teacher_report', 'class' => 'form-horizontal', 'method' => 'post', 'name' => 'basic_validate', 'id' => 'basic_validate', 'novalidate' => 'novalidate']) }}
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('#class_select').unbind().change(function() {
