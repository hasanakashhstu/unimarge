@extends('admin.index')
@section('Title','Library Invoice Generator')
@section('breadcrumbs','Library Invoice Generator')
@section('breadcrumbs_link','/library_bill_generator')
@section('breadcrumbs_title','Library Invoice Generator')
...
@endif
	...
	<div class="container">
  		<h2><i class="fa fa-money" aria-hidden="true"></i>Library Invoice Generator</h2> <!-- Tab Heading  -->
...
<div class='row'>
  ...
  {{Form::open(['url'=>'/library_bill_generator','files'=>true,'class'=>'form-horizontal','method'=>'post','name'=>'basic_validate','id'=>'basic_validate','novalidate'=>'novalidate'])}}
          ...
          <div class="widget-content nopadding">
            ...
            <input type="hidden" name="form_name" value="library">
      <div class="control-group">
      ...
      $(document).ready(function(){
        ...
        $(".class_data").unbind().change(function(){
          ...
          $('.department').unbind().change(function(){
              ...
              $.ajax({
                url: '/library_payment_entry_for_student_data',
                type: "post",
              ...
              var student_roll=$(this).val();
                ...
                $.ajax({
                  ...
                  success: function(data){
                    ...
                    $(".title").val(data.student_name+'/'+data.roll+'-'+data.class+'-Library Invoice');
