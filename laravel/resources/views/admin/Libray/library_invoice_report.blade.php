...
<div class="container">
<h2><i class="fa fa-money" aria-hidden="true"></i> &nbsp; Library Invoice Report</h2>
<!-- Tab Heading  -->
<p title="Transport Details">{{Session::get('school.system_name')}} Library Invoice's Report</p>
<!-- Transport Details -->
