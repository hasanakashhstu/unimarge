                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">                                          
                                            <select class="form-control" id="degree_name" name="degree_name" >
                                                ...
                                                <option value="{{ $degree_name_data_list->name }}" {{ $degree_name_data_list->name == $applicant_student->degree_name ? 'selected' : '' }} >{{ $degree_name_data_list->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="controls">
                                        <select class="form-control" id="session_choose" name="session_choose" >
                                            ...
                                            <option value="{{ $session_choose_data_list->name }}" {{ $session_choose_data_list->name == $applicant_student->session_choose ? 'selected' : '' }}>{{ $session_choose_data_list->name }}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select class="form-control" id="session" name="session" >
                                                    ...
                                                    <option value="{{ $value->type_name }}" {{ $value->type_name == $applicant_student->session ? 'selected' : '' }} >{{ $value->type_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="controls">
                                        <select class="form-control" id="" name="department"  >
                                            ...
                                            <option value="{{ $department_name_list->department_name }}" {{ $department_name_list->id == $applicant_student->department ? 'selected' : ''}} >{{ $department_name_list->department_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                            ...
                                            <div class="controls">
                                                <select class="form-control" id="" name="hall_of_residence"  >
                                                    ...
                                                    @foreach ($dormitory_name as $dormitory_name_list)
                                                      ...
                                                      <option value="{{  $dormitory_name_list->manage_dormitory_id }}" {{ $dormitory_name_list->manage_dormitory_id == $applicant_student->hall_of_residence ? 'selected' : ''}} >{{ $dormitory_name_list->dormitory_title}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="col-lg-6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            {{ Form::text('student_name_bangla', $applicant_student->student_name_bangla, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Student Name(bangla)', 'title' => 'student_name_bangla',''=>'true']) }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            {{ Form::text('student_name', $applicant_student->student_name, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Student Name(English)', 'title' => 'student_name',''=>'true']) }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            {{ Form::text('nid_birth', $applicant_student->nid_birth, ['class' => 'form-control', 'id' => '', 'placeholder' => 'National ID(If any)', 'title' => 'National ID(If any)',''=>'true']) }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            {{ Form::date('birth_date',  $applicant_student->birth_date, ['data-date-format' => 'mm-dd-yyyy','class' => 'form-control', 'id' => '', 'placeholder' => 'National ID', 'title' => 'National ID',''=>'true']) }}
                                ...
                                <div class="col-lg-6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            {{ Form::text('birth_registration',  $applicant_student->birth_registration, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Birth Registration No', 'title' => 'Birth Registration No',''=>'true']) }}
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select class="form-control" id="" name="religion"  >
                                                ...
                                                <option value="{{ $religion->id }} " {{ $religion->id == $applicant_student->religion ? 'selected' : '' }} >{{ $religion->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select class="form-control" id="" name="nationality" >
                                                ...
                                                <option value="{{ $nationality_data_list->name }} " {{ $nationality_data_list->id == $applicant_student->nationality ? 'selected' : '' }}>{{ $nationality_data_list->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select class="form-control" id="" name="maritial" >
                                                ...
                                                <option value="{{ $maritial_data_list->name }} " {{ $maritial_data_list->id == $applicant_student->maritial ? 'selected' : '' }} >{{ $maritial_data_list->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select class="form-control" id="" name="blood_group" >
                                                ...
                                                <option value="{{ $blood_group_data_list->name }} " {{ $blood_group_data_list->id == $applicant_student->blood_group ? 'selected' : '' }} >{{ $blood_group_data_list->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            {{ Form::text('income_guardian',  $applicant_student->income_guardian, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Income of the Guardian', 'title' => 'Income of the Guardian',''=>'true']) }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            {{ Form::text('email', $applicant_student->email, ['class' => 'form-control', 'id' => '', 'placeholder' => 'E-mail', 'title' => 'E-mail',''=>'true']) }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            {{ Form::text('phone', $applicant_student->phone, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Student’s Contact No', 'title' => 'Student’s Contact No',''=>'true']) }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            {{ Form::text('father_mobile_no', $applicant_student->father_mobile_no, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Father’s Contact No', 'title' => 'Father’s Contact No',''=>'true']) }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            {{ Form::text('mother_mobile_no', $applicant_student->mother_mobile_no, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Mother’s Contact No', 'title' => 'Mother’s Contact No']) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="col-lg-6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('father_name_bangla',  $applicant_student->father_name_bangla, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Father Name in Bangla', 'title' => 'Father Name in Bangla',''=>'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('father_name', $applicant_student->father_name, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Father Name in English', 'title' => 'Father Name in English',''=>'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('father_national_id_no', $applicant_student->father_national_id_no, ['class' => 'form-control', 'id' => '', 'placeholder' => 'National ID No', 'title' => 'National ID No',''=>'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('father_occupation', $applicant_student->father_occupation, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Occupation', 'title' => 'father_occupation',''=>'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="col-lg-6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('mother_name_bangla', $applicant_student->mother_name_bangla, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Mother Name in Bangla', 'title' => 'Mother Name in Bangla',''=>'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('mother_name', $applicant_student->mother_name, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Mother Name in English', 'title' => 'Mother Name in English',''=>'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('mother_national_id_no', $applicant_student->mother_national_id_no, ['class' => 'form-control', 'id' => '', 'placeholder' => 'National ID No', 'title' => 'National ID No',''=>'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('mother_occupation', $applicant_student->mother_occupation, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Occupation', 'title' => 'Occupation',''=>'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <tr class="educational_tr">
                                                        <td>
                                                            ...
                                                            <select class="form-control table_text" id="" name="exam_name[]"  >
                                                                ...
                                                                <option value="{{ $blood_group_data_list->name }} " {{ $exam_name->name == $applicant_student->blood_group ? 'selected' : '' }} >{{ $blood_group_data_list->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <td>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <select name="credit_transfer" id="credit_transfer" onchange="credit_transfer_();" class="form-control" >
                                                        <option value="" >--select--</option>
                                                        <option value="Yes" {{ 'Yes' == $applicant_student->credit_transfer ? 'selected' : ''}}>Yes</option>
                                                        <option value="No" {{ 'No' == $applicant_student->credit_transfer ? 'selected' : ''}}>No</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    {{ Form::text('credit_name_of_university', $applicant_student->credit_name_of_university, ['class' => 'form-control', 'id' => 'credit_transfer_institute_name', 'placeholder' => 'Institute Name', 'title' => 'Institute Name']) }}
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select name="year" class="form-control" id="credit_transfer_year" >
                                                        <option value="">--Select--</option>
                                                        @foreach ($year_data as $year_data_list)
                                                        <option value="{{ $year_data_list->name }}" {{ $year_data_list->name == $applicant_student->year ? 'selected' : ''}} >
                                                            {{ $year_data_list->name }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select name="semester" class="form-control" id="credit_transfer_semester" >
                                                        ...
                                                        <option value="{{ $semester_data_list->name }}" {{ $semester_data_list->name == $applicant_student->semester ? 'selected' : ''}} >
                                        ...
                                        <div class="col-lg-6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    {{ Form::text('credit', $applicant_student->credit, ['class' => 'form-control', 'id' => 'credit_completed', 'placeholder' => 'Credit Completed', 'title' => 'Credit Completed', '' => 'true']) }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    {{ Form::text('cgpa', $applicant_student->cgpa, ['class' => 'form-control', 'id' => 'credit_transfer_cgpa', 'placeholder' => 'CGPA', 'title' => 'CGPA','' => 'true']) }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <select name="division" class="p_divisions" >
                                                            ...
                                                            @foreach ($divisions_data as $divisions_data_list)
                                                            <option value="{{ $divisions_data_list->id }}" {{ $divisions_data_list->id == $aplicant_student_child->division ? 'selected' : '' }}>
                                                    ...
                                                    <td>
                                                        <input class="form-control village_name" id=""
                                                               ...
                                                               type="text" value="{{ $aplicant_student_child->village_name }}" >
                                                    ...
                                                    <td>
                                                        <input class="form-control post_office" id=""
                                                               ...
                                                               type="text" value="{{ $aplicant_student_child->post_office }}" >
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <select name="present_division" class="present_divisions" >
                                                            <option>--Select--</option>
                                                            @foreach ($divisions_data as $divisions_data_list)
                                                            <option value="{{ $divisions_data_list->id }}" {{ $divisions_data_list->id == $aplicant_student_child->present_division ? 'selected' : '' }}>
                                                                {{ $divisions_data_list->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <td>
                                                        <input class="table_text present_village_name"
                                                               ...
                                                               type="text" value="{{ $aplicant_student_child->present_village_name }}" >
                                                    ...
                                                    <td>
                                                        <input class="table_text present_post_office" id=""
                                                               ...
                                                               type="text" value="{{ $aplicant_student_child->present_post_office }}" >
                                                    </td>
                                                </tr>
                                ...
                                <div class="col-md-6">
                                    <div class="col-lg-12 clear_both">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('legal_gurdian_name_bangla',  $aplicant_student_child->legal_gurdian_name_bangla, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Legal Guardian Name(bangla)', 'title' => 'Legal Guardian Name(bangla)', ''=> 'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 clear_both">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('legal_gurdian_name',  $aplicant_student_child->legal_gurdian_name, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Legal Guardian Name', 'title' => 'Legal Guardian Name (English)', ''=> 'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <select class="form-control" id="" name="legal_gurdian_relation"  >
                                                    <option value="" >--Select--</option>
                                                    @foreach ($dependent_relation_data as $dependent_relation_data_list)
                                                    <option value="{{ $dependent_relation_data_list->name }}" {{ $dependent_relation_data_list->name == $aplicant_student_child->legal_gurdian_relation ? 'selected' : '' }} >{{ $dependent_relation_data_list->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <select class="form-control" id="" name="legal_gurdian_occupation"  >
                                                    <option value="" >--Select--</option>
                                                    @foreach ($profession_data as $profession_data_list)
                                                    <option value="{{ $profession_data_list->name }} " {{ $profession_data_list->name == $aplicant_student_child->legal_gurdian_occupation ? 'selected' : '' }} >{{ $profession_data_list->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('legal_gurdian_nid_no', $aplicant_student_child->legal_gurdian_nid_no, ['class' => 'form-control', 'id' => '', 'placeholder' => 'NID No.', 'title' => 'NID No.', '' => 'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('legal_gurdian_contact_no', $aplicant_student_child->legal_gurdian_contact_no, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Mobile No.', 'title' => 'Mobile No.', '' => 'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('legal_gurdian_address', $aplicant_student_child->legal_gurdian_address, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Present Address', 'title' => 'Present Address', '' => 'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="col-lg-12 clear_both">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('local_gurdian_name_bangla', $aplicant_student_child->local_gurdian_name_bangla, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Local Guardian Name(bangla)', 'title' => 'Local Guardian Name(bangla)', '' => 'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 clear_both">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('local_gurdian_name', $aplicant_student_child->local_gurdian_name, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Local Guardian Name(English)', 'title' => 'Legal Guardian Name', '' => 'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <select class="form-control" id="" name="local_gurdian_relation"  >
                                                    <option value="" >--Select--</option>
                                                    @foreach ($dependent_relation_data as $dependent_relation_data_list)
                                                    <option value="{{ $dependent_relation_data_list->name }} " {{ $dependent_relation_data_list->name == $aplicant_student_child->local_gurdian_relation ? 'selected' : '' }} >{{ $dependent_relation_data_list->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <select class="form-control" id="" name="local_gurdian_occupation"  >
                                                    <option value="" >--Select--</option>
                                                    @foreach ($profession_data as $profession_data_list)
                                                    <option value="{{ $profession_data_list->name }} " {{ $profession_data_list->name == $aplicant_student_child->local_gurdian_occupation ? 'selected' : '' }}>{{ $profession_data_list->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('local_gurdian_nid_no', $aplicant_student_child->local_gurdian_nid_no, ['class' => 'form-control', 'id' => '', 'placeholder' => 'NID No.', 'title' => 'NID No.', '' => 'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('local_gurdian_contact_no', $aplicant_student_child->local_gurdian_contact_no, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Mobile No.', 'title' => 'Contact No.', '' => 'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                {{ Form::text('local_gurdian_address', $aplicant_student_child->local_gurdian_address, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Present Address', 'title' => 'Present Address', '' => 'true']) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
