...
@section('content')
    ...
    <div class="container">
            ...
            <div class="panel panel-default">
                <div class="panel-body text-left">
                    <ul class='dropdown_test'>
                        <li><a href='/aplicant_student'><i class="fa fa-list-alt" aria-hidden="true"></i> &nbsp;Aplicant
                                Student</a></li>
                        <li><a href='/student_promoation'><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Student
                                Promation</a></li>
        ...
        <div class="alert alert-info">
            <strong>Warning!</strong> <br>If You Are Does Not Set Email And Password Then System Set Automatic Username
            and Password (Student Roll number Is By Default Username and Password)
        </div>
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <!-- {{ Form::open(['url' => '/admit_student', 'files' => true, 'class' => '', 'method' => 'post', 'name' => 'basic_validate', 'id' => 'basic_validate', 'novalidate' => 'novalidate']) }} -->
                {{-- ---------------------------- --}}
                <form action="/admit_student" method="post" enctype="multipart/form-data"
                    class="admin_student form-horizontal" id="basic_validate" novalidate='novalidate'>
                    ...
                    <div class="applicant_student_block">
                        <div class="col-lg-12">
                            ...
                            <div class="col-md-3">
                                <div class="control-group">
                                    {{ Form::label('Registration_number', 'Registration number', ['class' => 'control-label', 'title' => 'Registration Number']) }}
                                    <div class="controls">
                            ...
                            <div class="col-md-3">
                                <div class="control-group">
                                    {{ Form::label('roll', 'Student Roll', ['class' => 'control-label', 'title' => 'Student Roll']) }}
                                    <div class="controls">
                                        {{ Form::text('roll', '', ['id' => 'required', 'placeholder' => 'Student Roll', 'title' => 'roll', 'class' => 'generated_roll']) }}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control village_name" id="required"
                                                        ...
                                                        name="village_name" type="text" value="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="col-lg-12 input_fields_wrap">
                                    <table class="table education_history">
                                        ...
                                        <tbody class="educational_tbody" id="educational_tbody">
                                            <tr class="educational_tr">
                                                ...
                                                <td class="others_university" hidden='hidden'>
                                                    <input type="text" value="university_name[]"
                                                        class="form-control university_name" id="required"
                                                        placeholder="University Name" tittle="University Name"
                                                        style="width: 100%" />
                                                </td>
                                                <td>
                                        ...
                                        <td>{{Form::text('roll_no[]','',['class'=>'form-control', 'id'=>'required','placeholder'=>'Roll No.','title'=>'Roll No.','class'=>'table_text','style'=>'width: '])}}</td>
                                        ...
                                        <td>{{Form::text('gpa[]','',['class'=>'form-control', 'id'=>'required','placeholder'=>'Division/GPA','title'=>'Division/GPA','class'=>'table_text','style'=>'width: '])}}</td> --}}
                                                ...
                                                <td>
                                                    <input type="text" name="reg_no[]" class="form-control" id="required"
                                                        placeholder="Reg No" tittle="Reg No" style="width: 100%" />
                                                </td>
                                                <td>
                                                    <input type="text" name="roll_no[]" class="form-control"
                                                        id="required" placeholder="Roll No" tittle="roll_no"
                                                        style="width: 100%" />
                                                <td>
                                                    <input type="text" name="gpa[]" class="form-control table_text"
                                                        id="required" placeholder="Division/GPA" tittle="Division/GPA"
                                                        style="width: 100%" />
                                                </td>
                    ...
                    <div class="applicant_student_block_heading">Programs</div>
                    ...
                    <p>&nbsp;</p>
                    <div class="applicant_student_block_heading">Waiver (Particulars & Amount)</div>
                    <div class="applicant_student_block reference">
                        <div class="col-lg-12">
                            <div class="col-lg-4">
                                <div class="control-group">
                                    {{ Form::label('credit_fee', 'Credit Fee', ['class' => 'control-label', 'title' => 'Credit Fee']) }}
                                    <div class="controls">
                                        {{ Form::text('credit_fee', '', ['class' => 'form-control', 'id' => 'required', 'placeholder' => 'Credit Fee', 'title' => 'Credit Fee']) }}
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="control-group">
                                    {{ Form::label('admission_fee', 'Admission Fee', ['class' => 'control-label', 'title' => 'Admission Fee']) }}
                                    <div class="controls">
                                        {{ Form::text('admission_fee', '', ['class' => 'form-control', 'id' => 'required', 'placeholder' => 'Admission Fee', 'title' => 'Admission Fee']) }}
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="control-group">
                                    {{ Form::label('semester_fee', 'Semester Fee', ['class' => 'control-label', 'title' => 'Semester Fee']) }}
                                    <div class="controls">
                                        {{ Form::text('semester_fee', '', ['class' => 'form-control', 'id' => 'required', 'placeholder' => 'Semester Fee', 'title' => 'Semester Fee']) }}
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="control-group">
                                    {{ Form::label('hall_seat_charge', 'Hall Seat Charge', ['class' => 'control-label', 'title' => 'Hall Seat Charge']) }}
                                    <div class="controls">
                                        {{ Form::text('hall_seat_charge', '', ['class' => 'form-control', 'id' => 'required', 'placeholder' => 'Hall Seat Charge', 'title' => 'Hall Seat Charge']) }}
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="control-group">
                                    {{ Form::label('miscellaneous', 'Miscellaneous', ['class' => 'control-label', 'title' => 'Others']) }}
                                    <div class="controls">
                                        {{ Form::text('miscellaneous', '', ['class' => 'form-control', 'id' => 'required', 'placeholder' => 'Miscellaneous', 'title' => 'Miscellaneous']) }}
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="control-group">
                                    {{ Form::label('remark', 'Remarks', ['class' => 'control-label', 'title' => 'Remarks']) }}
                                    <div class="controls">
                                        {{ Form::text('remark', '', ['class' => 'form-control', 'id' => 'required', 'placeholder' => 'Remarks', 'title' => 'Remarks']) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="admit_student_block_heading">Authorization</div>
                    <div class="admit_student_block authorization">
                        <div class="control-group">
                    ...
                    {{-- ---------------------------- --}}
                    {{--  --}}
                    {{-- Old Designs --}}{{-- <div class="applicant_student_block_heading">Basic Information</div>
                <div class="admit_student_block basic_information_block">
                    <div class="control-group">
                        {{Form::label('student_name','Student Name',['class'=>'control-label','title'=>'student_name'])}}
                    ...
                    <div class="control-group">
                        {{Form::label('Sex','Sex',['class'=>'control-label','title'=>'sex'])}}
                        <div class="controls">
                ...
                <div class="admit_student_block_heading">Academic Information</div>
                <div class="admit_student_block academic_information">
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        {{Form::label('class','Pogram',['class'=>'control-label','title'=>'class'])}}

                        <div class="controls">
                            @php
                                $class_data_array=['--select--'=>'--select--']
                            @endphp
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            {{Form::select('section',$section,null,['required','id'=>'student_section'])}}
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        {{Form::label('reg_no','Reg No',['class'=>'control-label','title'=>'reg_no'])}}
                        <div class="controls">

                            {{Form::text('reg_no','',['id'=>'required','placeholder'=>'Reg No','title'=>'reg_no'])}}
                        </div>
                    </div>
                    <div class="control-group">
                        {{Form::label('student_id','Student Id',['class'=>'control-label','title'=>'student_id'])}}
                        <div class="controls">

                            {{Form::text('student_id','',['id'=>'required','placeholder'=>'Student Id','title'=>'student_id'])}}
                        </div>
                    </div>
                    <div class="control-group">
                        {{Form::label('Batch','Batch',['class'=>'control-label','title'=>'batcg'])}}
                ...
                <div class="admit_student_block_heading">Educational History</div>
                <div class="admit_student_block educational_history">
                    <div class="control-group">
      ...
      {{Form::text('reg_number','',['id'=>'required','placeholder'=>'Student Reg','title'=>'reg_number'])}}
                    ...
                    {{-- <div class="control-group is_family_member_of_hem_section" style="">
                  <div class="controls">
                      <table class="table address">
                          <thead>
                            <tr>
