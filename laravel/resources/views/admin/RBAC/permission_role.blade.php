...
@section('breadcrumbs', 'Permission Role')
@section('breadcrumbs_link', '/permission_role')
@section('breadcrumbs_title', 'Permission Role')
@section('content')
    ...
    <div class="container">
        ...
        <p title="Transport Details">{{ Session::get('school.system_name') }} &nbsp;Role Report</p>
            ...
            <div class="panel panel-default">
                <div class="panel-body text-left">
                    <ul class='dropdown_test'>
                        ...
                        <li><a href='/create_permission'><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Create
                                Permission</a></li>
                        <li><a href='/user_access'><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;User acess</a>
                        </li>
            ...
            <div class="controls text-right">
                <div data-toggle="buttons-checkbox" class="btn-group">
                    <button class="btn btn-default" title='Export PDF' type="button"><a target="_blank"
                            href="/role_based_permission_pdf_report"><i class="fa fa-file-pdf-o"
                                aria-hidden="true"></i></a></button>
                    <button class="btn btn-default" title='Export Excel' type="button"><a href="/role_permission_excel"><i
                    ...
                    <button class="btn btn-default" title='Preview' ttype="button"><a target="_blank"
                            href="/role_based_permission_pdf_report"><i class="fa fa-street-view"
                                aria-hidden="true"></i></a></button>
        ...
        <div class="tab-content">
            <div class="modal fade" style='width: 685px;margin-left: -6%;' id="myModal" role="dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="widget-content padding">
                                {{ Form::open(['url' => '/permission_role', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'basic_validate', 'id' => 'basic_validate']) }}
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        {{ Form::select('role_id', $auth_role_array) }}
                                    </div>
                                </div>
                    ...
                    <table class="table table-bordered data-table">
                        ...
                        <tbody>
                            ...
                            @foreach ($create_permission_role as $role_permission)
                                @php
                                    $permission_name = DB::table('roles')
                                        ->where('id', $role_permission->role_id)
                                        ->first();
                                @endphp
                                <tr class="gradeX">
                                    ...
                                    <td id="my_align" class="display_status">
                                        @can('manage role and permission')
                                            {{ Form::open(['url' => "/permission_role/$permission_name->id/edit", 'method' => 'GET']) }}
                                            {{ Form::submit('Edit', ['class' => 'btn btn-primary']) }}
                                            {{ Form::close() }}
                                        @endcan

                                        @can('manage role and permission')
                                            {{ Form::open(['url' => "/permission_role/$permission_name->id", 'method' => 'DELETE']) }}
    ...
    @push('custom-scripts')
        <script type="text/javascript" src="{{ asset('extra_js/permission_role.js') }}"></script>
    @endpush
@stop
