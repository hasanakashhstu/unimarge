...
@section('breadcrumbs', 'Create Results')
    ...
    <div class="widget-content nopadding">
        ...
        <div class="widget-box">
            ...
            <div class="widget-content padding">
                {{ Form::open(['url' => url('admin/results'),'class' => 'form-horizontal','method' => 'POST','files' => true,'name' => 'basic_validate','id' => 'basic_validate','novalidate' => 'novalidate']) }}
                ...
                <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            {{ Form::textarea('description', old('description'), ['id' => 'required','placeholder' => 'Designation','title' => 'Designation','id' => 'description']) }}
                        </div>
                    </div>
