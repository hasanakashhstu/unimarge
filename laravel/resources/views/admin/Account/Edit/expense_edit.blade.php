      ...
      <div class="panel-body text-left">
         <ul class='dropdown_test'> 
           ...
           <li><a href='/create_template'><i class="fa fa-plus-circle" aria-hidden="true"></i> &nbsp;Payment Templete</a></li>
            ...
            <li><a href='/expense'>&nbsp;<i class="fa fa-backward" aria-hidden="true"></i></a></li>
         </ul>
      </div>
    </div>
</div><br/>
...
{{Form::open(['url'=>"/expense/$expense_info->expense_id",'class'=>'form-horizontal','method'=>'put','name'=>'basic_validate','id'=>'basic_validate','novalidate'=>'novalidate'])}}
                

                <div class="control-group">
                {{Form::label('journal_title','Journal Title',['class'=>'control-label','title'=>'journal_title'])}}
                  <div class="controls">
                      {{Form::text('journal_title',$expense_info->journal_title,['id'=>'required','placeholder'=>'Journal Title','title'=>'journal_title'])}}
                  </div>
                </div>
                ...
                <div class="control-group">
                 {{Form::label('journal_type','Journal Type',['class'=>'control-label','title'=>'journal_type'])}}
                  <div class="controls">
                   ...
                   {{Form::select('journal_type',["$expense_info->journal_type"=>$expense_info->journal_type,'Earnings'=>'Earnings','Expense'=>'Expense'],null,['class'=>'journal'])}}
                  </div>
                </div>
                ...
                <div class="control-group" hidden="hidden" id="asset_account_list">
                  ...
                  <div class="controls">
                  @php $asset_account_list_array=[$expense_info->asset_account=>$expense_info->asset_account]; @endphp
                ...
                {{Form::label('expense_account','Expense Account',['class'=>'control-label','title'=>'expense_account'])}}
                  ...
                  @php $expense_acount_list_array=[$expense_info->expense_account=>$expense_info->expense_account]; @endphp
                ...
                <div class="control-group">
                 {{Form::label('amount_method','Amount Method',['class'=>'control-label','title'=>'amount_method'])}}
                  <div class="controls">
                   {{Form::select('amount_method',[$expense_info->amount_method=>$expense_info->amount_method,'Cash'=>'Cash','cheque'=>'cheque'],null,['class'=>'amount_method'])}}
                  </div>
                </div>
                ...
                {{Form::label('bank_name','Bank Name',['class'=>'control-label','title'=>'bank_name'])}}
                  <div class="controls">
                      {{Form::text('bank_name',$expense_info->bank_name,['id'=>'required','placeholder'=>'Bank Name','title'=>'bank_name'])}}
                  </div>
                </div>
                ...
                {{Form::label('cheque_no','cheque No',['class'=>'control-label','title'=>'cheque_no'])}}
                  <div class="controls">
                      {{Form::text('cheque_no',$expense_info->cheque_no,['id'=>'required','placeholder'=>'Cheque No','title'=>'cheque_no'])}}
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                     {{Form::select('status',[$expense_info->status=>$expense_info->status,'Draft'=>'Draft','Submit'=>'Submit'])}}
                  </div>
                </div>
                ...
                <div style="display: flex;justify-content: center;" class="control-group">
                    ...
                    <table class="table address">
                      ...
                      <tbody>
                       <tr>
                           <td>{{Form::text('purpose',$expense_child_info->purpose,['id'=>'a_table','placeholder'=>'Purpose','title'=>'purpose'])}}</td>
                          <td>{{Form::text('amount',$expense_child_info->amount,['id'=>'a_table','placeholder'=>'Amount','title'=>'amount'])}} </td>
                          <td>{{Form::text('allocate_amount',$expense_child_info->allocate_amount,['id'=>'a_table','placeholder'=>'Allocate Amount','title'=>'allocate_amount'])}}</td>
                          <td>{{Form::text('party_name',$expense_child_info->party_name,['id'=>'a_table','placeholder'=>'Party Name','title'=>'party_name'])}}</td> 
                        </tr>
                      </tbody>
                    </table>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                  {{Form::text('remark',$expense_info->remark,['id'=>'requried','placeholder'=>'Remark','title'=>'remark'])}}
                  </div>
                </div>
