  ...
  {{Form::open(['url'=>'/student_payment_entry','files'=>true,'class'=>'form-horizontal','method'=>'post','name'=>'basic_validate','id'=>'basic_validate','novalidate'=>'novalidate'])}}
        <div id="home" class="tab-pane fade in active">
          ...
          <div class="widget-content nopadding">
            ...
            <input type="hidden" name="form_name" value="academic">
      <div class="control-group">
          ...
          <div class="controls">
            ...
            <div class="control-group title_div">
                ...
                <div class="controls">
                  {{Form::text('total_month','',['id'=>'required','class'=>'total_month','required'=>'required'])}}
                </div>
            </div>
...
{{Form::close()}}
 ...
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
        ...
        $(".class_data").unbind().change(function(){
               ...
               $.ajax({
                   ...
                   success:function(dep){
                    ...
                    $('.department').html(dep);
                      ...
                      //  $(".department").append('<option value='+r[i].department_name+'>'+r[i].department_name+'</option>')
                      // }
                   }
               });
        });
          ...
          $('.waber_info').unbind().keyup(function(){
           ...
           $(".to_date").unbind().change(function(){
              ...
              var round=Math.trunc( month );
              console.log(round);
              if (round > 0){
                  $(".total_month").val(round);
              }else{
                  alert('From date and to date different minimum 1 month');
                  $(".total_month").val('');
                  $(".total_month").focus();
              }
            });
      ...
      //                 <input type='text' disabled='disabled' value="+val+" class='component_value'>\
      //                 </div>\
      //               </div>");
