...
<div class="container">
<h2><i class="fa fa-money" aria-hidden="true"></i> &nbsp; Transport Invoice Report</h2>
<!-- Tab Heading  -->
<p title="Transport Details">{{Session::get('school.system_name')}} Transport Invoice's Report</p>
<!-- Transport Details -->
  ...
  <div id="home" class="tab-pane fade in active">
    <div class="widget-box">
      <div class="widget-title">
        ...
        <h5>Transport Invoice Data Table
        </h5>
      </div>
