@extends('admin.index')
@section('Title', 'single_student_attendance_report')
@section('breadcrumbs', 'single_student_attendance_report')
@section('breadcrumbs_link', '/single_student_attendance_report')
@section('breadcrumbs_title', 'single_student_attendance_report')
@section('content')


    <div class="container">
        <h2><i class="fa fa-list-alt" aria-hidden="true"></i> &nbsp;Single Student Attendance Report</h2>
        <!-- Tab Heading  -->
        <p title="Transport Details">{{ Session::get('school.system_name') }} Single Student Attendance Report</p>
        <!-- Transport Details -->
        ...
        {{ Form::open(['url' => '/single_student_attendance_report', 'class' => 'form-horizontal', 'method' => 'post', 'name' => 'basic_validate', 'id' => 'basic_validate', 'novalidate' => 'novalidate']) }}
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        {{ Form::text('student_roll', '', ['style' => 'width: 183px', 'id' => 'student_roll', 'class' => 'student_roll']) }}
                    </td>
