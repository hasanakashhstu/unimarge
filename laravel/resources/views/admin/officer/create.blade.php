@extends('admin.index')
@section('Title', 'Create Department Officer')
...
@section('content')
    ...
    <div class="widget-content nopadding">
        <div class="container">
            <h2><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp;Create Department Officer</h2>
            <!-- Tab Heading  -->
        ...
        <div class="widget-box">
            <div class="widget-title">
                ...
                <h5>Create Department Officer</h5>
            </div>


            <div class="widget-content padding">
                {{ Form::open(['url' => url('admin/officers'),'class' => 'form-horizontal','method' => 'POST','files' => true,'name' => 'basic_validate','id' => 'basic_validate','novalidate' => 'novalidate']) }}
