@extends('admin.index')
@section('Title','Dormitory Invoice Generator')
@section('breadcrumbs','Dormitory Invoice Generator')
@section('breadcrumbs_link','/dormitory_bill_generator')
@section('breadcrumbs_title','Dormitory Invoice Generator')
...
@endif
	...
	<div class="container">
  		<h2><i class="fa fa-money" aria-hidden="true"></i>Dormitory Invoice Generator</h2> <!-- Tab Heading  -->
...
<div class='row'>
  ...
  {{Form::open(['url'=>'/dormitory_bill_generator','files'=>true,'class'=>'form-horizontal','method'=>'post','name'=>'basic_validate','id'=>'basic_validate','novalidate'=>'novalidate'])}}
          ...
          <div class="widget-content nopadding">
            ...
            <input type="hidden" name="form_name" value="dormitory">
      <div class="control-group">
...
<!-- 
            ...
            <div class="control-group title_div">
                ...
                <div class="controls">
                  {{Form::text('total_month','1',['id'=>'required','class'=>'total_month'])}}
                </div>
            </div>
      ...
      $(document).ready(function(){
        ...
        $(".class_data").unbind().change(function(){
          ...
          $('.department').unbind().change(function(){
              ...
              $.ajax({
                url: '/dormitory_payment_entry_for_student_data',
                type: "post",
              ...
              var student_roll=$(this).val();
                ...
                $.ajax({
                  ...
                  success: function(data){
                    ...
                    $(".title").val(data.student_name+'/'+data.roll+'-'+data.class+'-Dormitory Invoice');
