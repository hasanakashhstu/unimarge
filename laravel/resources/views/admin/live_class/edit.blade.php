        ...
        <div>
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    ...
                    <div class="multiple">
                        <div class="control-group append_parent">
                            {{Form::label('department','Department',['class'=>'control-label'])}}
                            @php $department_array = json_decode($live_class->department);@endphp
                            @foreach($department_array as $dpt)
                            <div class="controls clone_parent">
                                <select class="department" name="department[]">
                                    @foreach($departments as $single_department)
                                        <option {{$dpt == $single_department->department_name ? 'Selected' : ''}} value="{{$single_department->department_name}}">{{$single_department->department_name}}</option>
                                    @endforeach
                                </select>
                                <a class="btn btn-primary delete_dept">Delete Row</a>
                            </div>
                            @endforeach
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="controls">
                            <label></label>
                            <a class="btn btn-primary" id="clone_btn">Add Row</a>
                        </div>
                    </div>
                    <div class="control-group">
    ...
    <script>
        $(document).ready(function(){
            $('#clone_btn').click(function(){
                $(".append_parent").append($(".clone_parent:first").clone());
            });
