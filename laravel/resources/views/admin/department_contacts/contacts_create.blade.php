...
@section('content')
    ...
    <div class="widget-content nopadding">
        <div class="container">
            <h2><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp;Create Departmet Contact</h2>
            <!-- Tab Heading  -->
            <p title="Transport Details">{{ Session::get('school.system_name') }} Departmet Contact</p>
            <!-- Transport Details -->
        </div>
        ...
        <div class="widget-box">
            <div class="widget-title">
                ...
                <h5>Create Departmet Contact</h5>
            </div>


            <div class="widget-content padding">
                {{ Form::open(['url' => url('admin/department_contacts'),'class' => 'form-horizontal','method' => 'POST','files' => true,'name' => 'basic_validate','id' => 'basic_validate','novalidate' => 'novalidate']) }}
                ...
                <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            {{ Form::textarea('content', old('content'), ['placeholder' => 'Content','title' => 'Designation','id' => 'content_textarea']) }}
                        </div>
                    </div>
