@extends('admin.index')
@section('Title', 'Create Department Schollership')
...
@section('content')
    ...
    <div class="widget-content nopadding">
        <div class="container">
            <h2><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp;Create Department Schollership</h2>
            <!-- Tab Heading  -->
        ...
        <div class="widget-box">
            <div class="widget-title">
                ...
                <h5>Create Department Schollership</h5>
            </div>


            <div class="widget-content padding">
                {{ Form::open(['url' => url('admin/schollerships'),'class' => 'form-horizontal','method' => 'POST','files' => true,'name' => 'basic_validate','id' => 'basic_validate','novalidate' => 'novalidate']) }}
