@extends('admin.index')
@section('Title', 'Create Awards and Honours')
...
@section('content')
    ...
    <div class="widget-content nopadding">
        <div class="container">
            <h2><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp;Create Awards and Honours</h2>
            <!-- Tab Heading  -->
        ...
        <div class="widget-box">
            <div class="widget-title">
                ...
                <h5>Create Awards and Honours</h5>
            </div>


            <div class="widget-content padding">
                {{ Form::open(['url' => url('admin/award_honours'), 'class' => 'form-horizontal', 'method' => 'POST', 'files' => true, 'name' => 'basic_validate', 'id' => 'basic_validate', 'novalidate' => 'novalidate']) }}
                ...
                <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            {{ Form::textarea('content', old('content'), ['id' => 'required', 'placeholder' => 'Designation', 'title' => 'Designation', 'class' => 'ckeditor']) }}
                        </div>
                    </div>
